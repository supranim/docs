...
<div class="alert alert-info rounded-4" role="alert">
  <div class="alert-content">
    Supranim is still in early development, documentation is being written and updated as we go. If you have any questions or need help, feel free to reach out on <a href="https://github.com/supranim" class="alert-link">GitHub Discussion</a> pages.
  </div>
</div>
...
## Getting Started
To get started with Supranim, go through the [Installation Guide](/install) to set up your development environment. Also, check the [Dependencies page](/dependencies) to see the required libraries and tools for running Supranim.
